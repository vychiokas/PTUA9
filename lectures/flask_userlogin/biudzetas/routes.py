...
def send_reset_email(user):
    ...
    Jei jūs nedarėte šios užklausos, 
    nieko nedarykite ir slaptažodis nebus pakeistas.
    """
    print(msg.body)
    # mail.send(msg)
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash(
            """Jums išsiųstas el. laiškas su 
            slaptažodžio atnaujinimo instrukcijomis.""",
            "info",
        )
